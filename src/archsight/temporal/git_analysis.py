"""Temporal analysis via git history mining — requires archsight[temporal] extra."""
...
def mine_temporal_patterns(
    ...
    if Repo is None:
        raise ImportError("GitPython not installed. Install with: pip install archsight[temporal]")
